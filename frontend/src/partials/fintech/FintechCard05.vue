            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-slate-800 dark:text-slate-100">Dublin</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div>Big</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-emerald-500  text-right">-1,299.22 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-emerald-500 text-right">-272.88 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-slate-800 dark:text-slate-100">Galway</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div>Small</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-emerald-500 text-right">-999.44 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-slate-800 dark:text-slate-100">Cork</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div>Big</div>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-emerald-500 text-right">-1,029.77 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-emerald-500 text-right">-1,921.26 Co2e</div>
              </td>
            </tr>
          </tbody>
        </table>
