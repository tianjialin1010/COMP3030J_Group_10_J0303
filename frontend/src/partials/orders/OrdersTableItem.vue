...
<!--            <input :order_id="order.order_id" class="form-checkbox" type="checkbox" :value="value" @change="check" :checked="checked" />-->
<!--          </label>-->
<!--        </div>-->
<!--      </td>-->
...
<!--            :aria-controls="`description-${order.order_id}`"-->
<!--          >-->
...
<!--    &ndash;&gt;-->
<!--    <tr :order_id="`description-${order.order_id}`" role="region" :class="!descriptionOpen && 'hidden'">-->
