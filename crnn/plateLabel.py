...
# from alphabets_1 import plate_chr
...
if __name__=="__main__":
    ...
    parser.add_argument('--image_path', type=str, default="/home/zhenjue4/xcy_work/other/1/new", help='source') 
    parser.add_argument('--label_file', type=str, default='/home/zhenjue4/xcy_work/other/1/new.txt', help='model.pt path(s)')  
