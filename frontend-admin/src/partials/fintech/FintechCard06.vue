        ...
        <table class="table-auto w-full dark:text-slate-300">
          ...
          <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
            ...
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-red-500 text-right">+1,299.22 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-red-500 text-right">+1,200.88 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-red-500 text-right">+499.99 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-red-500 text-right">+2,179.36 Co2e</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="font-medium text-red-500 text-right">+249.88 Co2e</div>
              </td>
            </tr>
          </tbody>
        </table>
